export default function Lab1() {
    ...
    render the gaps.
            ...
            <div id="wd-lists">
                ...
                My favorite recipe - Chicken and Orzo:
                <ol id="wd-your-favorite-recipe">
                    <li>Add chicken breast to pot on medium heat</li>
                    <li>Mix chicken broth and can of tomatos in bowl</li>
                    <li>Flip Chicken and let cook</li>
                    <li>Add broth mixture to pot and change to medium low heat</li>
                    <li>Add orzo to pot</li>
                    <li>Put lid on and let cook for 10 minutes</li>
                    <li>Take off heat</li>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>Harry Potter</li>
                    <li>The Kane Chronicles: The Red Pyramid</li>
                </ul>
            </div>
            <div id="wd-tables">
                <h4>Table Tag</h4>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    Please
                    <a href="https://github.com/XHoke04?tab=repositories" id="wd-github" >click here</a>
